...
## 快速導覽
- [**888Bopomofo注音**](./888Bopomofo注音/README.md) - 基於 BpmfIansui，適合注音字型與台灣正體顯示。
- [**888Roundhand圓體**](./888Roundhand圓體/README.md) - 基於臺灣圓體，適合一般閱讀。
- [**888禪體**](./888zen禪體/README.md) - 基於苦累蛙圓體，具備手寫風格。
...
- **偽直排閱讀：** 各字族資料夾內的 `Rotated90偽直排` 版本適合舊型電子書設備。
...
---
#### 製作工具與教學
- **888 字型生成工具 (最新)** 採用自動化生成精靈： ㄔ[tbdavid2019/OpenCCFontGenerator](https://github.com/tbdavid2019/OpenCCFontGenerator)
